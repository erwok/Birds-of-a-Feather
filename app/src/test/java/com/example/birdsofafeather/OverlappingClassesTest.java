...
public class OverlappingClassesTest {
    ...
    public void overlappingTest() {
        ...
        Student student1 = new Student(0, "Rye Gleason", "https://variety.com/wp-content/uploads/2021/07/Rick-Astley-Never-Gonna-Give-You-Up.png");
        ...
        Student student2 = new Student(0, "Rye Gleason", "https://variety.com/wp-content/uploads/2021/07/Rick-Astley-Never-Gonna-Give-You-Up.png");
